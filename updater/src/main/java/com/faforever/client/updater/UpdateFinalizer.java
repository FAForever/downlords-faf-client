...
public class UpdateFinalizer {
  public static void main(String[] args) throws Exception {
    ...
    if (!Update.containsUpdate(updateArchive)) {
      System.out.println(updateArchive + " doesn't contain an update");
      return;
    }
    ...
    Path oldConfigFile = updateArchive.resolve("update4j-old.xml");
