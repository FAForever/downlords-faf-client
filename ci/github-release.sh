...
if [ ! -d "${INSTALL4J_DIR}" ] || [ ! -d "~/.install4j8/jres/windows-amd64-14.0.2.tar.gz" ]; then
  ...
  curl https://content.faforever.com/jre/windows-amd64-14.0.2.tar.gz -o "~/.install4j8/jres/windows-amd64-14.0.2.tar.gz"
