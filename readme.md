...
### Linux
Learn how to install the client on Linux in the [FAF wiki](https://wiki.faforever.com/en/Play/Linux-Install) (or [GitHub wiki mirror](https://github.com/FAForever/downlords-faf-client/wiki/Install-on-Linux)).
