...
public class MuteChatUserMenuItem extends AbstractMenuItem<ChatChannelUser> {
  ...
  protected boolean isDisplayed() {
    if (object == null || object.getCategory() == ChatUserCategory.SELF) {
      return false;
    }
    return !chatPrefs.isUserMuted(object.getUsername());
  }
