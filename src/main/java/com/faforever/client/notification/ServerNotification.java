...
public record ServerNotification(
  ...
  public ServerNotification(String title, String text, Severity severity) {
    this(title, text, severity, null);
  }

  public ServerNotification(String title, String text, Severity severity, List<Action> actions) {
    this(title, text, severity, null, actions, null);
  }

  public ServerNotification(String title, String text, Severity severity, Throwable throwable, List<Action> actions) {
    this(title, text, severity, throwable, actions, null);
  }

  public ServerNotification(String title, String text, Severity severity, List<Action> actions, Parent customUI) {
