...
import com.faforever.client.ui.list.NoListViewSelectionModel;
...
public class SettingsController implements Controller<Node> {
  ...
  private void initMirrorUrlsListView() {
    mirrorURLsListView.setSelectionModel(new NoListViewSelectionModel<>());
  ...
  private void initAutoChannelListView() {
    autoChannelListView.setSelectionModel(new NoListViewSelectionModel<>());
