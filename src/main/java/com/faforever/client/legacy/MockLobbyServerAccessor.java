    ...
    taskService.submitTask(NET_LIGHT, new PrioritizedTask<Void>(i18n.get("login.progress.message")) {
      ...
      protected Void call() throws Exception {
        ...
        for (OnGameInfoListener onGameInfoListener : onGameInfoListeners) {
          ...
          onGameInfoListener.onGameInfo(createGameInfo(2, "Mock game 2", PUBLIC, "faf", "scmp_011", 3, 6, "Mock user"));
          onGameInfoListener.onGameInfo(createGameInfo(3, "Mock game 3", PUBLIC, "faf", "scmp_012", 3, 6, "Mock user"));
          onGameInfoListener.onGameInfo(createGameInfo(4, "Mock game 4", PUBLIC, "faf", "scmp_013", 3, 6, "Mock user"));
          onGameInfoListener.onGameInfo(createGameInfo(5, "Mock game 5", PUBLIC, "faf", "scmp_014", 3, 6, "Mock user"));
