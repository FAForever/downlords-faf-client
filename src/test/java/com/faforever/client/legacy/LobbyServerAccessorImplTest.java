...
public class LobbyServerAccessorImplTest extends AbstractPlainJavaFxTest {
  ...
  public void testAccept1v1Match() throws Exception {
    ...
    assertEquals(accept1v1MatchMessage.getFactionchosen(), Faction.AEON);
  }
  ...
  public void startSearchRanked1v1WithAeon() throws Exception {
    ...
    clientMessage = messagesReceivedByFafServer.poll(TIMEOUT, TIMEOUT_UNIT);
    ...
    assertEquals(searchRanked1v1Message.getFaction(), "/aeon");
