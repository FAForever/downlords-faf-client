...
public class MapDetailControllerTest extends AbstractPlainJavaFxTest {
  ...
  public void setUp() throws Exception {
    ...
    instance = new MapDetailController(mapService, preferencesService, notificationService, i18n, timeService, reportingService, playerService, reviewService, eventBus);
